...
The *SBGNview* object is a S3 object defined as a list structure containing 'data' and 'output.file' elements. The object is created by the SBGNview S3 class defined within the package. The 'data' element of the object is a list containing information for all input SBGN pathways. Each element in 'data' is a list holding information of a single SBGN pathway. The information includes parsed glyphs, parsed arcs and SBGNview parameters passed into *SBGNview* function. The 'output.file' is a string specified for the 'output.file' parameter in *SBGNview* function. It contains the name of the output file. The code below demonstrates how you can access information of a *SBGNview* object. You can load a demo *SBGNview* object by running `data("SBGNview.obj")`. 
```{r , echo = TRUE, results = 'hide', message = FALSE, warning = FALSE}
