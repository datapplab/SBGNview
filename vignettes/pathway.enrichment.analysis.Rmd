...
```
Alternatively, install **SBGNview** through [GitHub](https://github.com/datapplab/SBGNview_2). Requires R (version >= 3.6).
```r install, eval = FALSE}
#install.packages("devtools")
devtools::install_github("datapplab/SBGNview")
```
#Complete pathway analysis + visaulization workflow
